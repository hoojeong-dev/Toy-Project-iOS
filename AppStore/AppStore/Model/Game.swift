...
struct GameList {
    var gameList = [
        ...
        Game(header: "무료 게임 순위", appIcon: "icApp", appRank: "6", appTitle: "헌터W", appDescription: "사냥의 재미를 찢는다! 헌터의 혼을 불태워라!", appProduce: "4399 KOREA", isPurchase: true),
        Game(header: "무료 게임 순위", appIcon: "icApp", appRank: "7", appTitle: "헌터W", appDescription: "사냥의 재미를 찢는다! 헌터의 혼을 불태워라!", appProduce: "4399 KOREA", isPurchase: true)
    ]
}
